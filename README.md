...
> Answer: Routing done within app which speeds up user experience, avoid loading site to continue retrieve information.  Components are loaded from client side.
